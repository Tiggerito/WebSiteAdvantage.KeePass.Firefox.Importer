            ...
            if (!_Loaded)
            {
                ...
                try
                {
                    ...
                    if (!File.Exists("WebSiteAdvantageKeePassFirefox-Gecko\\NSS312\\mozcrt19.dll"))
                        throw new Exception("Failed to find WebSiteAdvantageKeePassFirefox-Gecko\\NSS312\\mozcrt19.dll Please re-check the intallation process");

                    if (!File.Exists("WebSiteAdvantageKeePassFirefox-Gecko\\NSS312\\sqlite3.dll"))
                        throw new Exception("Failed to find WebSiteAdvantageKeePassFirefox-Gecko\\NSS312\\sqlite3.dll Please re-check the intallation process");
