		...
		public static void LoadDependencies()
		{
			if (!_Loaded)
			{
                ...
                if (!File.Exists("WebSiteAdvantageKeePassFirefox-Gecko\\NSS64\\mozcrt19.dll"))
                    throw new Exception("Failed to find WebSiteAdvantageKeePassFirefox-Gecko\\NSS64\\mozcrt19.dll Please re-check the intallation process");

                if (!File.Exists("WebSiteAdvantageKeePassFirefox-Gecko\\NSS64\\sqlite3.dll"))
                    throw new Exception("Failed to find WebSiteAdvantageKeePassFirefox-Gecko\\NSS64\\sqlite3.dll Please re-check the intallation process");
